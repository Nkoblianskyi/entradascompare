    ...
    <section className="border-y border-stone-200 bg-white">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-12 lg:items-stretch lg:gap-8">
          ...
          <div className="flex flex-col justify-between gap-4 rounded-2xl border-2 border-orange-800/20 bg-gradient-to-br from-orange-50 via-white to-amber-50/80 p-5 shadow-md lg:col-span-5">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-orange-900/80">Precio orientativo desde</p>
              {minPrice > 0 ? (
                <>
                  <p className="font-display mt-1 text-4xl font-bold tabular-nums text-stone-900 sm:text-5xl">
            ...
            <Link
              href="#ofertas"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-orange-800/30 bg-white px-4 py-2.5 text-sm font-bold text-orange-900 shadow-sm transition hover:bg-orange-50"
            >
              Ver colaboradores
